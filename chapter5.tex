...
Nem túl nagy meglepetésre, a legnagyobb korreláció minden esetben a pupilla súlypontjának koordinátái és a tesztpont koordinátái között mutatkozott. A $0,\!9$ feletti korrelációs együtthatók alapján bátran kijelenthető, hogy lehetséges a tekintetkövetést a pupillaként felismert ellipszis középpontjára alapuló eljárásokkal megvalósítani.

Látható azonban, hogy a többi paraméter esetében sem túlzottan kicsik a korrelációs együtthatók: a további fejlesztések során ezen plusz információként szolgálhatnak, javítva a tekintetkövetés pontosságát.
