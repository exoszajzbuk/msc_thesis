...
A TODO ábra az alkalmazás futtatása során készült képeket mutat be, kettőt kettőt a dinamikus követésről (zöld vonalakkal ábrázolva a pupilla előző 5 képkockán vett pozoícióját), valamint a generált hőtérképekről. Bár igaz a mondás: ,,egy kép többet ér ezer szónál'', azonban az elkészült alkalmazás bemutatására állóképek helyett mégis a mozgóképek a legalkalmasabbak. Az alkalmazás működését bemutató videók a \sectref{mellekletek} függelékben dokumentált címeken találhatóak meg, a kedves olvasó ezek megtekintésével alkothat még teljesebb képet az elkészített alkalmazásról.