...
A \figref{vegleges_vonal} \figref{vegleges_heat1} és \figref{vegleges_heat2} ábrák az alkalmazás futtatása során készült képeket mutatnak be, kettőt-kettőt a dinamikus követésről (zöld vonalakkal ábrázolva a pupilla előző 5 képkockán vett pozoícióját), valamint a generált hőtérképekről.
